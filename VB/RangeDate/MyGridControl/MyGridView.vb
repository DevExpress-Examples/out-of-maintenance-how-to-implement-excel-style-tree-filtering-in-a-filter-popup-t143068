...
Namespace DateRange
	...
	Public Class MyGridView
		...
		Public Function GetFilteredValues(ByVal column As GridColumn, ByVal showAll As Boolean, ByVal completed As DevExpress.Data.OperationCompleted) As Object()
			Return MyBase.GetFilterPopupValues(column, completed)
		End Function
		Protected Overrides Function GetFilterPopupValues(ByVal column As GridColumn, ByVal completed As OperationCompleted) As Object()
			Dim filterPopupValues() As Object = MyBase.GetFilterPopupValues(column, completed)
